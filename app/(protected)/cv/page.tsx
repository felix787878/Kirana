...
export default function CvPercobaanPage() {
  ...
  function handleContinueCreate() {
    ...
    router.push(`/cv/editor?id=${encodeURIComponent(newEntry.id)}&a=${encodeURIComponent(selectedColor.id)}`);
  }
              ...
              >
                ...
                <div className="space-y-3 p-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Link
                      href={`/cv/editor?id=${encodeURIComponent(item.id)}&a=${encodeURIComponent(item.accentId ?? "teal")}`}
